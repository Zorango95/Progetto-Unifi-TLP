...
\begin{frame}
	...
	\begin{itemize}
		...
		\item 
			Tornando alle \textit{Lambda Expression}, il \textbf{tipo} di una \textit{Lambda Expression} (\textbf{Target Type}) essere una \textbf{Interfaccia Funzionale}
	\end{itemize}
\end{frame}
...
\end{lstlisting}
		\item 
			Questo avviene, perchè la \textit{referenza} a una \textit{Lambda Expression} deve avere un tipo' \textbf{Interfaccia Funzionale}.
	\end{itemize}
\end{frame}
