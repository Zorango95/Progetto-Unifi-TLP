...
\begin{frame}
	\frametitle{\textbf{Conclusione}}
	\begin{itemize}
		\item
			A questo punto, lasciamo la parola alla nostra \textit{Professoressa}, che ci parlerà dei \textbf{Tipi Intersezione} e il loro uso con le \textit{Lambda Expression}.
	\end{itemize}
\end{frame}
